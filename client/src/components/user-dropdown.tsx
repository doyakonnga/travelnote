        ...
        {expanded &&
          <div ref={panel}>
            <div className="absolute right-0 z-20 w-72 py-2 mt-2 overflow-hidden bg-white rounded-md shadow-xl dark:bg-gray-800 border border-gray-500">
              ...
              <a href="/api/v1/users/logout" className="block px-4 py-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                Log Out
              </a>
            </div>
          </div>}
